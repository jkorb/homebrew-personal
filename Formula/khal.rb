class Khal < Formula
  ...
  resource "urwid" do
    url "https://github.com/urwid/urwid/archive/refs/tags/3.0.4.tar.gz"
    sha256 "e8f2dbe2fdd9141c62677d3fc77bb9fd0a07efc221592c3f8228e1c98bcb2102"
  end
  ...
  def install
    ...
    # urwid's GitHub tarball lacks SCM metadata; provide version for setuptools-scm.
    ENV["SETUPTOOLS_SCM_PRETEND_VERSION_FOR_URWID"] = "3.0.4"
